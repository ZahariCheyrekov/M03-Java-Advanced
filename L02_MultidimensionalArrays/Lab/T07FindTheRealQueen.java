...
public class T07FindTheRealQueen {
    ...
    private static void findPositions(char[][] matrix, ArrayDeque<Integer> queue) {
        ...
        while (!queue.isEmpty()) {
            ...
            //searching in row from left to right
            ...
            //searching in row from right to left
            ...
            //searching in column from top to middle
            ...
            //searching in column from middle to bottom
